...
var cpuHistoricalChart = new Chart(ctx, {
  ...
  data: {
    labels: [],
    datasets: [{
      label: 'История изменения моментальной загрузки процессора',
      data: [],
      borderColor: 'blue',
      fill: false
    }]
...
var cpuAverageChart = new Chart(ctx, {
  ...
  data: {
    labels: [],
    datasets: [{
      label: 'График усредненной загрузки процессора (среднее значение за 1 минуту)',
      data: [],
      borderColor: 'blue',
      fill: false
    }]
  ...
  options: {
    ...
    title: {
      display: true,
      text: 'График усредненной загрузки процессора (среднее значение за 1 минуту)'
    },
    scales: {
      xAxes: [{
        type: 'time',
